...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	try
	{
		...
		while (true)
		{
			...
			cout << "DataTime " << tm.wMonth << "." << tm.wDay 
				<< ".2021" << " " << endl << tm.wHour + 3 
				<< " Hours " << tm.wMinute << " Minuts " 
				<< tm.wSecond << " Seconds " << tm.wMilliseconds 
				<< " MiliSeconds " << endl << inet_ntoa(client.sin_addr) 
