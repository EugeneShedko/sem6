...
namespace CentralizedServer
{
    class Program
    {
        public static string ip = "192.168.45.107";
            ...
            await Task.Run(() =>
            {
                while(true)
                {
                    ...
                    try
                    {
                        ...
                        Console.WriteLine("Отправка запроса на данные первому клиенту...");
            ...
            await Task.Run(() =>
            {
                while (true)
                {
                    ...
                    try
                    {
                        ...
                        Console.WriteLine("Отправка запроса на состояние первому клиенту...");
                        sendBytes = handler.Send(outMessage);
                        //-------------------------------------------------------
            ...
            await Task.Run(() =>
            {
                while (true)
                {
                    ...
                    try
                    {
                        ...
                        Console.WriteLine("Отправка запроса на данные второму клиенту...");
                        sendBytes = handler.Send(outMessage);
                        //-------------------------------------------------------
            ...
            await Task.Run(() =>
            {
                while (true)
                {
                    ...
                    try
                    {
                        ...
                        Console.WriteLine("Отправка запроса на состояние второму клиенту...");
                        sendBytes = handler.Send(outMessage);
                        //-------------------------------------------------------
